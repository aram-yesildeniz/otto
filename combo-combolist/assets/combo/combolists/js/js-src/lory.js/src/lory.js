...
export function lory (slider, opts) {
    ...
    function slide (nextIndex, direction) {
        ...
        const isLargeWindow = window.matchMedia('(min-width: 1020px)').matches;
        const positionOffset = isLargeWindow ? 2 : 1;
        if (nextCtrl && !infinite && !rewind && ((nextIndex + positionOffset) === slides.length)) {
